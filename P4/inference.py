...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        #     newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, self.particles[index]))
...
class JointParticleFilter:
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for i in range(self.numGhosts):
                new_pos_dist = getPositionDistributionForGhost(setGhostPositions(gameState, newParticle), i, self.ghostAgents[i])
                newParticle[i] = util.sample(new_pos_dist)
