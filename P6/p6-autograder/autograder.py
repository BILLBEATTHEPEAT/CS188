...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP, edxOutput=False, gsOutput=False, muteOutput=False,
    ...
    grades = grading.Grades(projectParams.PROJECT_NAME, questions, edxOutput=edxOutput, gsOutput=gsOutput, muteOutput=muteOutput)
    if questionToGrade == None:
